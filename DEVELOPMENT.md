...
```bash
git remote add encore encore://alevia-downloader-app-42gi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/alevia-downloader-app-42gi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/alevia-downloader-app-42gi/settings/integrations/github)
