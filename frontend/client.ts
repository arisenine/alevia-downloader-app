 ...
 */
export class Client {
    public readonly downloader: downloader.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.downloader = new downloader.ServiceClient(base)
    }
...
export namespace downloader {
    ...
    export class ServiceClient {
         ...
         */
        public async download(params: RequestType<typeof api_downloader_download_download>): Promise<ResponseType<typeof api_downloader_download_download>> {
            // Now make the actual call to the API
